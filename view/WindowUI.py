...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sync_select_all_ps.setGeometry(QtCore.QRect(90, 680, 92, 22))
        ...
        self.sync_ps_to_cas.setGeometry(QtCore.QRect(220, 680, 75, 23))
        self.sync_ps_to_cas.setObjectName("sync_ps_to_cas")
        self.sync_cas_to_ps = QtGui.QPushButton(self.centralwidget)
        self.sync_cas_to_ps.setGeometry(QtCore.QRect(510, 680, 75, 23))
